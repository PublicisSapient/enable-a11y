...
<head>
    ...
    <link id="link-css" rel="stylesheet" type="text/css" href="css/pause-animations-demo.css" />
...
<body>
    ...
    <div id="css-anim-example">
        <div class="play-pause-anim__full-bleed-image-demo">
            <div class="play-pause-anim__checkbox-container">
                <h1>Pause Animations Demo</h1>
                <p>
                    Pause all the CSS, Canvas, SVG SMIL and GIF
                    animations on this page with the checkbox below.
                    The CSS, Canvas and SVG SMIL animations don't
                    anything about the checkbox. The GIF animations
                ...
                <input type="checkbox" id="play-pause-animation-button" class="play-pause-animation-button__checkbox" />
            </div>
            <picture>
                <source
    ...
    <main>
        <?php includeShowcode("css-anim-demo")?>
        <script type="application/json" id="css-anim-demo-props">
        {
            "replaceHTMLRules": {},
            "steps": [{
        ...
        <p>
            The animation of saturn that appears above is
        ...
        <!-- SMIL demo from https://codepen.io/madetoday/pen/MYxYeo by Lenka (codepen @madetoday) -->
