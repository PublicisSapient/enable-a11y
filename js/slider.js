$(document).ready(function() {
  ...
  slider.prototype.createHandle = function(val, num) {
    ...
    var handle = '<img id="' + id + '" class="' + (this.vert == true ? 'v':'h') +'sliderHandle" ' +
      'src="images/slider_' + (this.vert == true ? 'v':'h') + '.png" ' + 'role="slider" ' +
  ...
  slider.prototype.handleFocus = function($handle, evt) {
    ...
    $handle.attr('src', 'images/slider_' + (this.vert == true ? 'v' : 'h') + '-focus.png');
  ...
  slider.prototype.handleBlur = function($handle, evt) {
    ...
    $handle.attr('src', 'images/slider_' + (this.vert == true ? 'v' : 'h') + '.png');
  ...
  slider.prototype.handleMouseDown = function($handle, evt) {
    ...
    $('.hsliderHandle').attr('src', 'images/slider_h.png').removeClass('focus').css('z-index', '10');
    $('.vsliderHandle').attr('src', 'images/slider_v.png').removeClass('focus').css('z-index', '10');
