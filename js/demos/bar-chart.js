...
const lineChartDemo = function (chartSel, tableSel) {
  ...
  const $rawDataTab = document.querySelector('.enable-tab[href="#bar-chart__heading--raw-data"]');
  ...
  const myBarChart = new Chartist.Bar(chartSel, data, options, responsiveOptions);
