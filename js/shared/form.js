  ...
  $("form.js-form-validation").validate({
    ...
    invalidHandler: function(form) {
      ...
      for (let i = 0; i < formFields.length; i += 1) {
        ...
        if (formField.nodeName !== 'FIELDSET' && formField.required && !isValid) {
          ...
          if (ariaDesc !== null && ariaDesc.indexOf(newAriaDesc) >= 0) {
            ...
            formField.setAttribute('aria-describedby', ariaDesc + ' ' + formField.id + '-error');
          }
...
$.validator.methods.phoneNumber = function( value, element ) {
  return this.optional( element ) || /[0-9]{3}-{0,1}[0-9]{3}-{0,1}[0-9]{4}/.test( value );
}
