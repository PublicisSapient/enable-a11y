//import accessibility from "../../enable-node-libs/accessibility-js-routines/dist/accessibility.module";
...
const search = new (function() {
    ...
    this.init3 = () => {
        ...
        //const comboboxElement = document.querySelector('.enable-combobox');
        //const combobox = new enableComboboxes();
        enableComboboxes.init();
        console.log("initlaize 3")
        ...
        //Add custom event listener for input and populating the output
        document.getElementById('aria-fruit').addEventListener('input', function(e) {


            console.log("aria-fruit")
        });
