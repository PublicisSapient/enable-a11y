...
<div id="example2" class="enable-example enable-carousel__example">
  ...
  <div class="glider-contain" role="region" aria-label="Store Announcements Carousel" id="announcements-carousel__container">
    ...
    <div id="announcements-carousel" class="glider enable-carousel enable-carousel--has-focusable-arrow-buttons" aria-labelledby="announcements-carousel__container" aria-describedby="carousel-instructions" tabindex="0">
