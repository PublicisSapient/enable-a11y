<p>
    Marquees are meant for content that scrolls or updates consistently, like a stock ticker or a news feed. 
    Although they have a default <code>aria-live</code> value of <code>off</code>, you can use <code>aria-live="polite"</code> to let users hear the information within a marquee in almost real-time.  Do this carefully. It would be a bad user experience to have a screen reader update too often. The rest of your application will become unusable to screen reader users due to too much screen reader noise caused by too many alerts.
</p>
