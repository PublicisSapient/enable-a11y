<main>
        ...
        <ol>
            ...
            <li>They must adhere to contrast requirements of <a                     href="https://www.w3.org/WAI/WCAG21/Understanding/contrast-minimum">WCAG 1.4.3 - Contrast
                    (Minimum)</a>
            </li><li>They must accomodate the adjustable text-spacing guidelines of <a                     href="https://www.w3.org/WAI/WCAG21/Understanding/text-spacing.html">WCAG 1.4.12 - Text Spacing</a>.
            </li>
            <li>They must be resizeable via a browser's text zooming feature to conform to <a                     href="https://www.w3.org/WAI/WCAG21/Understanding/resize-text">WCAG 1.4.4 - Text Resize</a>.</li>
        </ol>
            ...
            <div class="text-resize__hero">
                <div class="text-resize__container">
                    ...
                    <picture>
                        ...
                        <source                             srcset="images/text-resize/cuneyt-portrait-729.webp 729w, images/text-resize/cuneyt-portrait-375.webp 375w"
                            type="image/webp">
