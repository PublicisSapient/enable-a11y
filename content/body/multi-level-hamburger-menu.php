...
<p>
  This is the component that the most development and testing time was spent on. On many sites I have done accessibility audits on, there is a main navigation that appears as a traditional flyout menu on the desktop breakpoint, and a mobile hamburger menu on
  the tablet and mobile breakpoints.  More often than not, this component would have several accessibility issues:
</p>

<ol>
    <li>On desktop, when the user opened a menu flyout and tabbed through the flyout to the next flyout button, the flyout wouldn't close.</li>
