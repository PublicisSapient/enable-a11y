...
<div class="enable-example">
    ...
    <div id="html-disabled" class="button-container">
        <p>If you want to give Zoltan your data, push this:</p>
        <button disabled id="html-disabled-button">Surrender my data to Zoltan</button>
    </div>
    <p> The following button is disabled with aria-disabled="true"</p>
    <div id="aria-disabled" class="button-container">
        <p>If you want to give Zoltan your data, push this:</p>
        <button aria-disabled="true" id="aria-disabled-button">Surrender my data to Zoltan</button>
    </div>
    ...
    <div id="aria-js-disabled" class="button-container">
        <p>If you want to give Zoltan your data, push this:</p>
        <button aria-disabled="true" id="aria-js-disabled-button">Surrender my data to Zoltan</button>
    </div>
</div>
