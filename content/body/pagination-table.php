...
<p>
  <strong>That said, it is a bit of work for a keyboard and screen reader use to any pagination UI, even if it is
    accessible.</strong> It may be easier for users to navigate <a href="table.php#sticky-header-example">a table with a sticky header
