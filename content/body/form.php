...
<p> Forms must be marked up correctly for screen reader users to be able to use them correctly. Please ensure all your forms are marked up like in the following examples. </p>
<h2 id="html5" tabindex="-1">HTML5 example</h2>
<?php includeStats(["isForNewBuilds" => true]); ?>
<p> If you are marking up a form from scratch, use the HTML5 <code>fieldset</code> and <code>legend</code> tags to describe groups of elements. This makes the forms more understandable to screen reader users since they understand the context of the information they will be filling out as they tab through the form. </p>
<p> <strong>Note that these tags can be difficult to style.</strong> I would suggest reading the following articles to go over how this is done. <a href="https://thatemil.com/">Emil Björklund</a> has a great article on how to <a href="https://thatemil.com/blog/2015/01/03/reset-your-fieldset/">Reset your fieldset</a> that should help. </p>
<div id="example1" class="enable-example">
    <form class="enable-form-example">
        <fieldset aria-describedby="example1__instructions">
            ...
            <p id="example1__instructions" class="enable-form-example__instructions"><span class="required-symbol">*</span> denotes a required field.</p>
            <div class="enable-form-example__fieldset-inner-container">
                <div class="field-block">
                    <label class="required" for="name_html5" >Name </label>
                    <input id="name_html5" size="25" type="text">
                </div>
                <div class="field-block">
                    <label class="required" for="email_html5">E-mail </label>
                    <input id="email_html5" size="25" type="text">
                </div>
                <div class="field-block">
                    <label class="required" for="phone_html5">Phone </label>
...
<p> Unfortunately, there will be times when you will come across a bit of code that is supposed to be a form but is not marked up correctly and is unusable to screen reader users. Recoding it with <code>fieldset</code> and <code>legend</code> tags may be prohibitive due to: </p>
<ul>
    <li>The <code>legend</code> tag must always be the first child of the <code>fieldset</code> tag.</li>
    <li>The issues that devs have with styling <code>fieldset</code> and <code>legend</code> tags, as mentioned in the section above.</li>
    <li>The amount of JavaScript rework that would be needed to make the application work with <code>fieldset</code> and <code>legend</code> tags. </li>
</ul>
<p> While I would still endeavor to advise to code forms correctly, the following code should reduce the amount of coding time on existing work to fix accessibility issues for screen reader users.</p>
<div id="example2" class="enable-example">
    <div role="form" class="enable-form-example">
        <div role="group" aria-labelledby="contact-aria" aria-describedby="example2__instructions" class="fieldset aria-form-group">
            ...
            <p id="example2__instructions" class="enable-form-example__instructions"><span class="required-symbol">*</span> denotes a required field.</p>
            <div class="enable-form-example__fieldset-inner-container">
                <div class="field-block">
