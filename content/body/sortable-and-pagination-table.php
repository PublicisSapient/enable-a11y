  ...
  <div class="pagination deque-table-sortable__group">
    <div id="pagination-table-example__desc--top" class="sr-only">
      <p>
        ...
        the data in the table below, 7 columns at a time.
      </p>
    </div>
    ...
    <div class="pagination__alert deque-table-sortable__live-region sr-only" role="alert" aria-live="polite" data-read-captions="false" ></div>

    <div id="pagination-table-example__desc--bottom" class="sr-only">
      <p>
        The buttons inside this control allow you to paginate through
        the data in the table above, 7 columns at a time.
      </p>
    </div>
