...
<p>
  On the web, captions are usually saved in <a href="https://developer.mozilla.org/en-US/docs/Web/API/WebVTT_API">the WebVTT format</a>.  There are a few caption editors that you can use to edit caption files:
</p>

<ul>
  <li><a href="https://www.wgbh.org/foundation/services/ncam/cadet">CADET</a> is a free to download subtitle editor from <a href="https://www.wgbh.org/">WGBH</a>, the Boston PBS member TV station who is a pioneer in open and closed captioning on TV.  While it runs on any operating system that runs <a href="https://nodejs.org">Node</a>, it requires some technical knowledge to run.</li> 
  <li><a href="https://www.nikse.dk/subtitleedit">Subtitle Edit</a> is a very feature rich subtitle editor that is open source and free to download.  While it is a Windows application, I have used it under Linux using <a href="https://www.mono-project.com/">mono</a>.</li>
  </ul>
  
<p>Note that these are only two examples of captioning software.  They are listed here as examples, and may or may not be useful for your usecase.</p>

<p>Captioning by hand may take a long time, depending on the length and the complexity of the video. You could hire a third party to create them for you if your budget allows, or use AI to create the first pass and then edit the caption file afterwards to ensure accuracy.
...
<p>
  Furthermore, non-verbal sound effects in the video can be integral to understanding content or videos for deaf and hard of hearing users.  Human caption writers will usually describe these sound effects inside parantheses. For example: in a horror film, the noises made a horror film by something offscreen can be captioned as "(a squeaky door opening can be heard in the distance)". Similar captions could describe a buzzer indicating a wrong answer or end of the round
  that isn't announced by the host in a game show. These are overt examples, but it is a huge reason auto captions should not be a replacement but rather a starting point for providing accessible captioning (and transcripts).
</p>
    ...
    <ol>
      ...
      <li>They can be provided in a different audio track in the video. On broadcast television in North America, this
        has be implemented using <a href="https://en.wikipedia.org/wiki/Second_audio_program">Secondary Audio
          Programming</a>.</li>
      <li>They can be recited by a computer voice speaking over the video content, as shown in our demo of AblePlayer on <a href="video-player.php#video-player-with-text-to-speech-audio-descriptions--heading">the Enable Accessible Video Player page</a>.</li>
      <li>They can be provided by an alternate cut of the video.  You would just need to have a link to that audio described version on the video page.  An example of this is on <a href="https://www.youtube.com/watch?v=euI8FJvfmqc">the Killer B Cinema Trailer for 3 Dev Adam</a> (with the audio described version linked in the video description).</li>
    </ol>
...
<div
  role="figure"
  aria-labelledby="aria-caption1"
>
  <img src="images/multimedia/pokemon.jpg" alt="A young boy wearing a cap, a blue jacket, and gloves is excitedly looking at a small yellow creature with long ears in front of him. They are both facing a large red background." />
  <span id="aria-caption1">
    A still from <a href="https://en.wikipedia.org/wiki/Denn%C5%8D_Senshi_Porygon">Dennō Senshi Porygon</a>, an episode of <a href="https://en.wikipedia.org/wiki/Pok%C3%A9mon_(anime)">the Pokémon TV show</a> that caused some children to have seizures in 1997, due to a huge area of the screen flashing red and white.
  </span>
</div>
...
<p>Just like live HTML text over images, overlayed text in video must have enough contrast to be legible. Unlike live HTML text, it is impossible to enlarge this text or change the colour of overlayed text via CSS, since it is "burned in" to the pixels of the video. An example is in the image below.</p>

<div
  role="figure"
  aria-labelledby="aria-caption--overlay"
>
  <img src="images/multimedia/overlay-text.jpg" alt="Two martial artists are engaged in combat in an outdoor setting with traditional buildings in the background. The text 'PRODUCTION MANAGER: RICHARD CHEUNG' is overlaid in large white letters across the image. Some of this text is hard to read due to the white text blending in with some of the light gray buildings in the background." />
  <span id="aria-caption--overlay">
  A screenshot from the opening credits from <a href="https://en.wikipedia.org/wiki/Dance_of_the_Drunk_Mantis">the film "Dance of the Drunk Mantis"</a>. 

  </span>
</div>

<p>While you could check foreground and background colours of individual pixels using a tool like the WebAIM Contrast Checker, what I usually do is take a screenshot of the video frame with the burned in text and use a screenshot-based tool like <a href="https://chromewebstore.google.com/detail/color-contrast-analyzer/dagdlcijhfbmgkjokkjicnnfimlebcll?hl=en">Color Contrast Analyzer Chrome Plugin</a> offered by <a href="https://accessibility.oit.ncsu.edu/">IT Accessibility at NC State</a>.</p>
  

<div
  role="figure"
  aria-labelledby="aria-caption--overlay2"
>
  <img src="images/multimedia/overlay-text-2.jpg" alt="Two men fighting in the background with words overlayed on top that read 'Also Starring: Sun Kwei (as Rubber Legs student'), Charlier Shek (as Moneybags)'.  Like the previous screenshot, some of the text is hard to read since the white text sometimes blends into the light background of the ground." />
  <span id="aria-caption--overlay2">
  Another screenshot from the opening credits from <a href="https://en.wikipedia.org/wiki/Dance_of_the_Drunk_Mantis">the film "Dance of the Drunk Mantis".</a>. 
  </span>
</div>

<div
  role="figure"
  aria-labelledby="aria-caption--overlay2a"
>
  <img src="images/multimedia/overlay-text-2a.jpg" alt="A screenshot of the WCAG 2.0 Contrast Checker plugin for Chrome testing the previous screenshot. It outlines a lot of the text, but some of it is not outlined, which indicates the text doesn't have proper contrast." />
...
<div
  role="figure"
  aria-labelledby="aria-caption--killer-b-1"
>
  <img src="images/multimedia/killerb-1.jpg" alt="A screenshot from the trailer of a film.  There is easy-to-read text overlayed on top of the action in the background that reads 'Killer B Cinema proudly presents'." />
  <span id="aria-caption--killer-b-1">
  A screenshot from <a href="https://youtu.be/V9ofOPLoMHg">the trailer for the 1973 Turkish film Karate Girl</a>. Note that the text is easy to read due to the addition of dark text shadowing around the text onscreen.
  </span>
</div>
