...
<script type="application/ld+json">
{
  ...
  "@type": "WebPage",
  "name": "How to Create Accessible Checkboxes",
  "description": "Here is a step-by-step guide to creating accessible checkboxes",
  "url": "https://www.useragentman.com/enable/checkbox.php",
  "mainEntity": [
      {
      "@type": "Article",
      "name": "A real styled HTML5 checkbox",
      "articleBody": "You can style an HTML5 checkbox using CSS easily.",
      "url": "https://www.useragentman.com/enable/checkbox.php#a-real-styled-html5-checkbox--heading"
      },
      {
      "@type": "HowTo",
      "name": "Step-by-Step to make the styled checkboxe accessible",
      "text": "See the dropdown to highlight each of the individual steps that make the styled checkboxe accessible",
      "url": "https://www.useragentman.com/enable/checkbox.php#developer-walkthrough-1"
      },
      {
      "@type": "Article",
      "name": "A DIV with a role of checkbox",
      "articleBody": "If you come across a <div> in that is marked up like a checkbox, that is not accessible",
      "url": "https://www.useragentman.com/enable/checkbox.php#a-div-with-a-role-of-checkbox--heading"
      },
      {
      "@type": "HowTo",
      "name": "Step-by-Step to make the styled checkboxe accessible",
      "text": "See the dropdown to highlight each of the individual steps that make a <div> that is marked up like a checkbox accessible",
      "url": "https://www.useragentman.com/enable/checkbox.php#developer-walkthrough-2"
      },
      {
      "@type": "Article",
      "name": "HTML checkbox group",
      "articleBody": "If you have a group of checkboxes, you could use <role='group'> instead of fieldsets",
      "url": "https://www.useragentman.com/enable/checkbox.php#html-checkbox-group--heading"
      },
      {
      "@type": "HowTo",
      "name": "Step-by-Step to make a group of checkboxes accessible",
      "text": "See the dropdown to highlight each of the individual steps that make a group of checkboxes accessible",
      "url": "https://www.useragentman.com/enable/checkbox.php#developer-walkthrough-3"
      },
      {
      "@type": "Article",
      "name": "Indeterminate Checkboxes Using Native HTML",
      "articleBody": "We usually think of checkboxes being either checked or unchecked. There is a third possible state: indeterminate. Note that this indeterminate state can be set via JavaScript. There is no indeterminate HTML attribute.",
      "url": "https://www.useragentman.com/enable/checkbox.php#indeterminate-checkboxes-using-native-html--heading"
      },
      {
      "@type": "HowTo",
      "name": "Step-by-Step Indeterminate Checkboxes Using Native HTML",
      "text": "See the dropdown to highlight each of the individual steps that make the example accessible.",
      "url": "https://www.useragentman.com/enable/checkbox.php#developer-walkthrough-5"
      },
      {
      "@type": "Article",
      "name": "Indeterminate Checkboxes Using ARIA",
      "articleBody": "Just like two-state checkboxes, we can use ARIA to create faux checkboxes.",
      "url": "https://www.useragentman.com/enable/checkbox.php#indeterminate-checkboxes-using-aria--heading"
      },
      {
      "@type": "HowTo",
      "name": "Step-by-Step Indeterminate Checkboxes Using ARIA",
      "text": "See the dropdown to highlight each of the individual steps that make the example accessible.",
      "url": "https://www.useragentman.com/enable/checkbox.php#developer-walkthrough-7"
      },
      {
      "@type": "HowTo",
      "name": "How to Install the Hierarchical Checkbox Library into Your Projects",
      "text": "See the step-by-step installation guide for the Hierarchical Checkbox Library",
