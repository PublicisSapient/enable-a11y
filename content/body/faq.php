<dl>
  ...
  <dd>Enable is a place where developers can learn how to make accessible code. We show examples of different components
    ...
    complex, we create an NPM module for it so that developers can incorporate it into their own projects.</dd>
  ...
  <dd>Absolutely! Please send us a PR (see the previous comment). If you would like to discuss this with us first,
    ...
    open up a new issue describing the code you would like to donate and a sample page on how it works.</dd>

  <dt>Do you have any advice on how I can add automated accessibility testing to my CI/CD pipeline?</dt>
  <dd>
    Enable uses a few tools to find the 20% to 50% of accessibility errors that can be captured by automated tools.  We have also
