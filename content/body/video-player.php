...
<h2>Video Player With Human Read Audio Descriptions</h2>

<div id="example2">
  <div class="enable-video-player">
    <video data-able-player id="video2" data-youtube-id="euI8FJvfmqc" data-youtube-desc-id="f3C3U56Jlek" preload="auto" data-skin="2020"
      data-root-path="./js/enable-libs/ableplayer/" data-heading-level="3">
      <track kind="captions" src="vtt/3-dev-adam__trailer--captions.vtt" srclang="en" label="English">
      <track kind="descriptions" src="vtt/3-dev-adam__trailer--audio-desc.vtt" srclang="en"
        label="English Audio Descriptions">
    </video>
  </div>
</div>
...
<script type="application/json" id="example2-props">
{
  ...
  "steps": [{
    ...
    },
    {
      "label": "Include YouTube video ID",
      "highlight": "data-youtube-id",
      "notes": "If you video is already on YouTube, it is the one that appears as the <code>v</code> variable in the URL (e.g. <code>https://www.youtube.com/watch?v=<strong>NINogq4BS68</strong></code>)"
    },
    {
      "label": "Include YouTube video ID for video with audio descriptions",
      "highlight": "data-youtube-desc-id",
      "notes": "This is the version of the video with the audio descriptions.  You will have to upload it seperately to YouTube."
    },
    {
      "label": "Add appropriate heading level",
      "highlight": "data-heading-level",
    ...
    },
    {
      ...
      "highlight": "%OPENTAG%track",
      "notes": "Note that <code>kind</code> attribute should be set to <code>captions</code>."
    },
    {
      "label": "Write the captions track",
      "highlight": "%FILE%vtt/3-dev-adam-captions.vtt",
      "notes": "WebVTT is the web standard format that all videos should use for video captions.  <a href=\"https://nikse.dk/SubtitleEdit/\">Subtitle Edit</a> was the tool used to create all the WebVTT files on this page.  Althought it is a Windows program, there are <a href=\"https://www.nikse.dk/SubtitleEdit/Help#linux\">instructions on how to run Subtitle Edit on Linux</a>."
    },
    {
      "label": "Add AblePlayer customizations",
