...
<p>
    ...
    more accessible, we have added a tiny bit of JavaScript code (inspired by <a
        href="https://pauljadam.com/guides/html5-form.html">this accessible HTML5 forms code demo by Paul J Adam</a>) in
    order to ensure the error messages
        ...
        <fieldset>
            ...
            <div class="enable-form-example__fieldset-inner-container">
                ...
                <div class="field-block">
                    ...
                    <input id="phone_html5" size="25" type="text" required
                        pattern="[0-9]{3}-{0,1}[0-9]{3}-{0,1}[0-9]{4}" aria-describedby="phone-desc" autocomplete="tel">
...
<p>
    ...
    <a href="https://medium.com/@lsnrae/accessible-form-validation-9fa637ddb0fc">Alison Walden's excellent article on
        form validation</a>.
</p>
        ...
        <fieldset>
            ...
            <div class="enable-form-example__fieldset-inner-container">
                ...
                <div class="field-block">
                    ...
                    <input id="phone_js" name="phone_js" size="25" type="text" required
                        pattern="[0-9]{3}-{0,1}[0-9]{3}-{0,1}[0-9]{4}" aria-describedby="phone-desc2">
                ...
                <div class="field-block" role="group" aria-labelledby="example-date_js__label example-date_js__desc">
                    <label for="example-date_js" id="example-date_js__label">Birthday:</label>
                    <input type="date" min="2005-01-01" value="1999-08-29" max="2019-01-01" id="example-date_js"
                        aria-describedby="example-date_js__desc">
                    <div id="example-date_js__desc" class="desc">Date is in the yyyy-mm-dd format</div>
                </div>
            </div>
