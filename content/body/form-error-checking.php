...
<p> You can use just the <code>required</code> and <code>pattern</code> attributes on HTML forms to do client-side validation <strong>without JavaScript</strong>. However, to make the messaging more accessible, we have added a tiny bit of JavaScript code (inspired by <a href="https://pauljadam.com/guides/html5-form.html">this accessible HTML5 forms code demo by Paul J Adam</a>) to ensure the error messages themselves are more accessible to screen reader users (see the last step in the code walkthrough for details). </p>
        ...
        <fieldset>
            ...
            <div class="enable-form-example__fieldset-inner-container">
                ...
                <div class="field-block">
                  ...
                  autocomplete="tel"
                >
                    <div id="phone-desc" class="desc"> Format is <span aria-hidden="true">xxx-xxx-xxxx <br> (where x is a digit, and dashes are optional) </span> <span class="sr-only">a three digit area code, followed by another three digits, followed by another four digits, all separated with optional dashes.</span></div>
                </div>
                <div class="field-block">
                    <label for="do-contact_html5">Send me promotion updates</label>
                    <input type="checkbox" id="do-contact_html5" name="terms" />
                </div>
...
<p> You can do the custom validation as well, but you have to ensure that when the form is submitted and there is an error, the first input value with an error receives focus so that keyboard and/or screen reader users can correct mistakes easily. You also have to ensure that form errors are marked up as <code>&lt;label&gt;</code> tags for the form fields they are associated with. </p>
<p> The following example used <a href="https://jqueryvalidation.org">jQuery.validate()</a> which is not accessible. We do not recommend using this library for new projects. It is just used as an example of how we can take existing code and make it accessible. If you want information about how to make forms accessible with JavaScript in the general sense, please read <a href="https://medium.com/@lsnrae/accessible-form-validation-9fa637ddb0fc">Alison Walden's excellent article on form validation</a>. </p>
    ...
    <form novalidate class="js-form-validation enable-form-example">
        <fieldset>
            ...
            <div class="enable-form-example__fieldset-inner-container">
                ...
                >
                    <div id="phone-desc2" class="desc"> Format is <span aria-hidden="true">xxx-xxx-xxxx <br> (where x is a digit, and dashes are optional) </span> <span class="sr-only">a three digit area code, followed by another three digits, followed by another four digits, all separated with optional dashes.</span></div>
                </div>
                <div class="field-block">
                    <label for="do-contact_js">Send me promotion updates</label>
                    <input type="checkbox" id="do-contact_js" name="terms" />
                </div>
