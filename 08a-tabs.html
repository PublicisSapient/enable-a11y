    ...
    <main>
        ...
        <div id="tabs">
            <ul role="tablist" aria-describedby="tabs-keyboard-only-instructions"
                ...
                <li role="presentation"><a href="#ipa" role="tab" aria-owns="ipa-tabpanel"
                        aria-describedby="tabs-keyboard-only-instructions">India Pale Ale (IPA)</a></li>
                <li role="presentation"><a href="#gueuze" role="tab" aria-owns="gueuze-tabpanel"
                        aria-describedby="tabs-keyboard-only-instructions">Gueuze</a></li>
                <li role="presentation"><a href="#imperial-stout" role="tab" aria-owns="imperial-stout-tabpanel"
                        aria-describedby="tabs-keyboard-only-instructions">Imperial Stout</a></li>
            </ul>
