        ...
        <div id="example2-submit-on-select">
            ...
            implementing the following steps.</strong></p>
                ...
                <form class="showcode__ui">                                        <div id="example2-submit-on-select__steps" class="showcode__steps"></div>
                                        <div id="example2-submit-on-select__notes" class="showcode__notes read-more" role="alert" aria-live="assertive"></div>
        ...
        <div id="dataset-example">
            ...
            <p>
                ...
                <form class="showcode__ui">                                        <div id="dataset-example__steps" class="showcode__steps"></div>
                                        <div id="dataset-example__notes" class="showcode__notes read-more" role="alert" aria-live="assertive"></div>
