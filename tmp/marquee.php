        ...
        <div id="marquee-example" class="enable-example">
            ...
            <p>
                ...
                example accessible.
                                    ...
                                    <div class="showcode">
                <form class="showcode__ui">                                        <div id="marquee-example__steps" class="showcode__steps"></div>
                                        <div id="marquee-example__notes" class="showcode__notes " role="alert" aria-live="assertive"
                    ></div>
                    <button id="marquee-example__notes-view-toggle" class="showcode__notes-view-toggle" aria-describedby="marquee-example__toggle-desc"><span
                        class="showcode__notes-view-toggle--more">View More</span><span
                        class="showcode__notes-view-toggle--less">View Less</span>
                    </button>
                    <div id="marquee-example__toggle-desc" class="sr-only">This control is not needed for screen reader users.</div>
                ...
                <pre class="showcode__example"><code
                        data-showcode-id="marquee-example"
                        data-showcode-props="marquee-example-props"
                        tabindex="0"
                        aria-describedby="marquee-example__example-desc"
                    >
                    </code>
                </pre>
            </div>
        </div>        <script type="application/json" id="marquee-example-props">
        {
            "replaceHtmlRules": {},
            "steps": [{
                    "label": "Add role",
