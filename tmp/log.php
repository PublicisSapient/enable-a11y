...
<span>Initializing.  Please wait …</span>
            ...
            <p>
                ...
                example accessible.
                                    ...
                                    <div class="showcode">
                <form class="showcode__ui">                                        <div id="log-example__steps" class="showcode__steps"></div>
                                        <div id="log-example__notes" class="showcode__notes " role="alert" aria-live="assertive"
                    ></div>
                    <button id="log-example__notes-view-toggle" class="showcode__notes-view-toggle" aria-describedby="log-example__toggle-desc"><span
                        class="showcode__notes-view-toggle--more">View More</span><span
                        class="showcode__notes-view-toggle--less">View Less</span>
                    </button>
                    <div id="log-example__toggle-desc" class="sr-only">This control is not needed for screen reader users.</div>
                ...
                <pre class="showcode__example"><code
                        data-showcode-id="log-example"
                        data-showcode-props="log-example-props"
                        tabindex="0"
                        aria-describedby="log-example__example-desc"
                    >
                    </code>
                </pre>
            </div>
        </div>        <script type="application/json" id="log-example-props">
        {
            "replaceHtmlRules": {
                "#syslog": [
                    "<span>Initializing.  Please wait …</span>",
