...
<div role="banner">
  ...
  <img src="images/main-menu/accessible-text-svg.png" alt="" class="enable-flyout__link-image" />
    ...
    <main>
        ...
        <div id="example1a" >
            ...
            <p>
                ...
                <form class="showcode__ui">                                        <div id="example1a__steps" class="showcode__steps"></div>
                                        <div id="example1a__notes" class="showcode__notes " role="alert" aria-live="assertive"
                    ></div>
                    <button id="example1a__notes-view-toggle" class="showcode__notes-view-toggle" aria-describedby="example1a__toggle-desc"><span
                        class="showcode__notes-view-toggle--more">View More</span><span
                        class="showcode__notes-view-toggle--less">View Less</span>
                    </button>
                    <div id="example1a__toggle-desc" class="sr-only">This control is not needed for screen reader users.</div>
                ...
                <pre class="showcode__example"><code
                        ...
                        tabindex="0"
                        aria-describedby="example1a__example-desc"
                    >
                    </code>
                </pre>
            </div>
        ...
        <div id="example-aria-multiselect" >
            <div class="enable-drawer enable-multiselect">
                <button id="aria-dropdown-multiselect" class="enable-drawer__button enable-multiselect__button" aria-controls="aria-dropdown-multiselect__content"
                        aria-expanded="false">
                        Products
                </button>
            ...
            <p>
                ...
                example accessible.
                                    ...
                                    <div class="showcode">
                <form class="showcode__ui">                                        <div id="example-aria-multiselect__steps" class="showcode__steps"></div>
                                        <div id="example-aria-multiselect__notes" class="showcode__notes " role="alert" aria-live="assertive"
                    ></div>
                    <button id="example-aria-multiselect__notes-view-toggle" class="showcode__notes-view-toggle" aria-describedby="example-aria-multiselect__toggle-desc"><span
                        class="showcode__notes-view-toggle--more">View More</span><span
                        class="showcode__notes-view-toggle--less">View Less</span>
                    </button>
                    <div id="example-aria-multiselect__toggle-desc" class="sr-only">This control is not needed for screen reader users.</div>
                ...
                <pre class="showcode__example"><code
                        data-showcode-id="example-aria-multiselect"
                        data-showcode-props="example-aria-multiselect-props"
                        tabindex="0"
                        aria-describedby="example-aria-multiselect__example-desc"
                    >
                    </code>
                </pre>
            </div>
        ...
        <div id="example-multi-level">
            ...
            <p>
                ...
                <form class="showcode__ui">                                        <div id="example-multi-level__steps" class="showcode__steps"></div>
                                        <div id="example-multi-level__notes" class="showcode__notes " role="alert" aria-live="assertive"
                    ></div>
                    <button id="example-multi-level__notes-view-toggle" class="showcode__notes-view-toggle" aria-describedby="example-multi-level__toggle-desc"><span
                        class="showcode__notes-view-toggle--more">View More</span><span
                        class="showcode__notes-view-toggle--less">View Less</span>
                    </button>
                    <div id="example-multi-level__toggle-desc" class="sr-only">This control is not needed for screen reader users.</div>

                    <div id="example-multi-level__example-desc" class="showcode__example--desc">
                        ☜ Scroll to see full source ☞
                    </div>
                                    </form>
                <pre class="showcode__example"><code
                        ...
                        tabindex="0"
                        aria-describedby="example-multi-level__example-desc"
                    >
                    </code>
                </pre>
            </div>
