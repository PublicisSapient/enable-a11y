        ...
        <div id="html5-focus-example" class="enable-example">
            ...
            <p>
                ...
                <form class="showcode__ui">                                        <div id="html5-focus-example__steps" class="showcode__steps"></div>
                                        <div id="html5-focus-example__notes" class="showcode__notes " role="alert" aria-live="assertive"
                    ></div>
                    <button id="html5-focus-example__notes-view-toggle" class="showcode__notes-view-toggle" aria-describedby="html5-focus-example__toggle-desc"><span
                        class="showcode__notes-view-toggle--more">View More</span><span
                        class="showcode__notes-view-toggle--less">View Less</span>
                    </button>
                    <div id="html5-focus-example__toggle-desc" class="sr-only">This control is not needed for screen reader users.</div>
                ...
                <pre class="showcode__example"><code
                        ...
                        tabindex="0"
                        aria-describedby="html5-focus-example__example-desc"
                    >
                    </code>
                </pre>
            </div>
        ...
        <div id="aria-valuetext-example" class="enable-example">
            ...
            <p>
                ...
                <form class="showcode__ui">                                        <div id="aria-valuetext-example__steps" class="showcode__steps"></div>
                                        <div id="aria-valuetext-example__notes" class="showcode__notes " role="alert" aria-live="assertive"
                    ></div>
                    <button id="aria-valuetext-example__notes-view-toggle" class="showcode__notes-view-toggle" aria-describedby="aria-valuetext-example__toggle-desc"><span
                        class="showcode__notes-view-toggle--more">View More</span><span
                        class="showcode__notes-view-toggle--less">View Less</span>
                    </button>
                    <div id="aria-valuetext-example__toggle-desc" class="sr-only">This control is not needed for screen reader users.</div>
                ...
                <pre class="showcode__example"><code
                        ...
                        tabindex="0"
                        aria-describedby="aria-valuetext-example__example-desc"
                    >
                    </code>
                </pre>
            </div>
