        ...
        <div id="equation" class="enable-example">
            ...
            <p>
                ...
                <form class="showcode__ui">                                        <div id="equation__steps" class="showcode__steps"></div>
                                        <div id="equation__notes" class="showcode__notes " role="alert" aria-live="assertive"
                    ></div>
                    <button id="equation__notes-view-toggle" class="showcode__notes-view-toggle" aria-describedby="equation__toggle-desc"><span
                        class="showcode__notes-view-toggle--more">View More</span><span
                        class="showcode__notes-view-toggle--less">View Less</span>
                    </button>
                    <div id="equation__toggle-desc" class="sr-only">This control is not needed for screen reader users.</div>
                ...
                <pre class="showcode__example"><code
                        ...
                        tabindex="0"
                        aria-describedby="equation__example-desc"
                    >
                    </code>
                </pre>
            </div>
