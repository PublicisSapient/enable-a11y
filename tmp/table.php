    ...
    <main>
        ...
        <div class="enable-example" id="table-example1">
            ...
            <p>
                ...
                <form class="showcode__ui">                                        <div id="table-example1__steps" class="showcode__steps"></div>
                                        <div id="table-example1__notes" class="showcode__notes " role="alert" aria-live="assertive"
                    ></div>
                    <button id="table-example1__notes-view-toggle" class="showcode__notes-view-toggle" aria-describedby="table-example1__toggle-desc"><span
                        class="showcode__notes-view-toggle--more">View More</span><span
                        class="showcode__notes-view-toggle--less">View Less</span>
                    </button>
                    <div id="table-example1__toggle-desc" class="sr-only">This control is not needed for screen reader users.</div>
                ...
                <pre class="showcode__example"><code
                        ...
                        tabindex="0"
                        aria-describedby="table-example1__example-desc"
                    >
                    </code>
                </pre>
            </div>
        ...
        <figure>
            ...
            <p>
                ...
                <form class="showcode__ui">                                        <div id="complex-table__steps" class="showcode__steps"></div>
                                        <div id="complex-table__notes" class="showcode__notes " role="alert" aria-live="assertive"
                    ></div>
                    <button id="complex-table__notes-view-toggle" class="showcode__notes-view-toggle" aria-describedby="complex-table__toggle-desc"><span
                        class="showcode__notes-view-toggle--more">View More</span><span
                        class="showcode__notes-view-toggle--less">View Less</span>
                    </button>
                    <div id="complex-table__toggle-desc" class="sr-only">This control is not needed for screen reader users.</div>
                ...
                <pre class="showcode__example"><code
                        ...
                        tabindex="0"
                        aria-describedby="complex-table__example-desc"
                    >
                    </code>
                </pre>
            </div>
        ...
        <div role="row">
            <div role="presentation">
                ...
                <div class="showcode__container">
                        <div class="showcode">
                                                        <div id="role-presentation-code__notes" class="showcode__notes " role="alert" aria-live="assertive"
                    ></div>
                    <button id="role-presentation-code__notes-view-toggle" class="showcode__notes-view-toggle" aria-describedby="role-presentation-code__toggle-desc"><span
                        class="showcode__notes-view-toggle--more">View More</span><span
                        class="showcode__notes-view-toggle--less">View Less</span>
                    </button>
                    <div id="role-presentation-code__toggle-desc" class="sr-only">This control is not needed for screen reader users.</div>
                ...
                <pre class="showcode__example"><code
                        data-showcode-id="role-presentation-code"
                        data-showcode-props="role-presentation-code-props"
                        tabindex="0"
                        aria-describedby="role-presentation-code__example-desc"
                    >
                    </code>
                </pre>
            </div>
        </div>        <script type="application/json" id="role-presentation-code-props">
        {
            "replaceHtmlRules": {
            },
            "steps": [
        ...
        <div class="enable-example" id="aria-example-1">
            ...
            <p>
                ...
                <form class="showcode__ui">                                        <div id="aria-example-1__steps" class="showcode__steps"></div>
                                        <div id="aria-example-1__notes" class="showcode__notes " role="alert" aria-live="assertive"
                    ></div>
                    <button id="aria-example-1__notes-view-toggle" class="showcode__notes-view-toggle" aria-describedby="aria-example-1__toggle-desc"><span
                        class="showcode__notes-view-toggle--more">View More</span><span
                        class="showcode__notes-view-toggle--less">View Less</span>
                    </button>
                    <div id="aria-example-1__toggle-desc" class="sr-only">This control is not needed for screen reader users.</div>
                ...
                <pre class="showcode__example"><code
                        ...
                        tabindex="0"
                        aria-describedby="aria-example-1__example-desc"
                    >
                    </code>
                </pre>
            </div>
        ...
        <div class="enable-example" id="complex-aria-example">
            ...
            <p>
                ...
                <form class="showcode__ui">                                        <div id="complex-aria-example__steps" class="showcode__steps"></div>
                                        <div id="complex-aria-example__notes" class="showcode__notes " role="alert" aria-live="assertive"
                    ></div>
                    <button id="complex-aria-example__notes-view-toggle" class="showcode__notes-view-toggle" aria-describedby="complex-aria-example__toggle-desc"><span
                        class="showcode__notes-view-toggle--more">View More</span><span
                        class="showcode__notes-view-toggle--less">View Less</span>
                    </button>
                    <div id="complex-aria-example__toggle-desc" class="sr-only">This control is not needed for screen reader users.</div>
                ...
                <pre class="showcode__example"><code
                        ...
                        tabindex="0"
                        aria-describedby="complex-aria-example__example-desc"
                    >
                    </code>
                </pre>
            </div>
        ...
        <div class="enable-example" id="sortable-table-example">
            ...
            <p>
                ...
                <form class="showcode__ui">                                        <div id="sortable-table__steps" class="showcode__steps"></div>
                                        <div id="sortable-table__notes" class="showcode__notes " role="alert" aria-live="assertive"
                    ></div>
                    <button id="sortable-table__notes-view-toggle" class="showcode__notes-view-toggle" aria-describedby="sortable-table__toggle-desc"><span
                        class="showcode__notes-view-toggle--more">View More</span><span
                        class="showcode__notes-view-toggle--less">View Less</span>
                    </button>
                    <div id="sortable-table__toggle-desc" class="sr-only">This control is not needed for screen reader users.</div>

                    <div id="sortable-table__example-desc" class="showcode__example--desc">
                        ☜ Scroll to see full source ☞
                    </div>
                                    </form>
                <pre class="showcode__example"><code
                        ...
                        tabindex="0"
                        aria-describedby="sortable-table__example-desc"
                    >
                    </code>
                </pre>
            </div>
        ...
        <div class="enable-example" id="paginated-table-example">
            ...
            <p>
                ...
                <form class="showcode__ui">                                        <div id="paginated-table-example__steps" class="showcode__steps"></div>
                                        <div id="paginated-table-example__notes" class="showcode__notes " role="alert" aria-live="assertive"
                    ></div>
                    <button id="paginated-table-example__notes-view-toggle" class="showcode__notes-view-toggle" aria-describedby="paginated-table-example__toggle-desc"><span
                        class="showcode__notes-view-toggle--more">View More</span><span
                        class="showcode__notes-view-toggle--less">View Less</span>
                    </button>
                    <div id="paginated-table-example__toggle-desc" class="sr-only">This control is not needed for screen reader users.</div>
                ...
                <pre class="showcode__example"><code
                        ...
                        tabindex="0"
                        aria-describedby="paginated-table-example__example-desc"
                    >
                    </code>
                </pre>
            </div>
        ...
        <div class="enable-example" id="sticky-header-table-example">
            ...
            <p>
                ...
                <form class="showcode__ui">                                        <div id="sticky-header-table-example__steps" class="showcode__steps"></div>
                                        <div id="sticky-header-table-example__notes" class="showcode__notes " role="alert" aria-live="assertive"
                    ></div>
                    <button id="sticky-header-table-example__notes-view-toggle" class="showcode__notes-view-toggle" aria-describedby="sticky-header-table-example__toggle-desc"><span
                        class="showcode__notes-view-toggle--more">View More</span><span
                        class="showcode__notes-view-toggle--less">View Less</span>
                    </button>
                    <div id="sticky-header-table-example__toggle-desc" class="sr-only">This control is not needed for screen reader users.</div>
                ...
                <pre class="showcode__example"><code
                        ...
                        tabindex="0"
                        aria-describedby="sticky-header-table-example__example-desc"
                    >
                    </code>
                </pre>
            </div>
