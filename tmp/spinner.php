        ...
        <aside class="notes">
            ...
            <ul>
                <li>
                    ...
                    <a
                        href="https://web.archive.org/web/20170424171217/http://oaa-accessibility.org/examplep/spinbutton1/">Example
        ...
        <div id="non-quantity-example" class="enable-example">
            ...
            <p>
                ...
                example accessible.
                                    ...
                                    <div class="showcode">
                <form class="showcode__ui">                                        <div id="non-quantity-example__steps" class="showcode__steps"></div>
                                        <div id="non-quantity-example__notes" class="showcode__notes " role="alert" aria-live="assertive"
                    ></div>
                    <button id="non-quantity-example__notes-view-toggle" class="showcode__notes-view-toggle" aria-describedby="non-quantity-example__toggle-desc"><span
                        class="showcode__notes-view-toggle--more">View More</span><span
                        class="showcode__notes-view-toggle--less">View Less</span>
                    </button>
                    <div id="non-quantity-example__toggle-desc" class="sr-only">This control is not needed for screen reader users.</div>
                ...
                <pre class="showcode__example"><code
                        data-showcode-id="non-quantity-example"
                        data-showcode-props="non-quantity-example-props"
                        tabindex="0"
                        aria-describedby="non-quantity-example__example-desc"
                    >
                    </code>
                </pre>
            </div>
        </div>        <script type="application/json" id="non-quantity-example-props">
        {
          "replaceHtmlRules": {
          },
          "steps": [
