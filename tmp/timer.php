...
<div role="banner">
  ...
  <img src="images/main-menu/accessible-text-svg.png" alt="" class="enable-flyout__link-image" />
    ...
    <main>
        ...
        <aside class="notes">
            ...
            <p>This demo is based on code from
                <a
                    href="https://css-tricks.com/how-to-create-an-animated-countdown-timer-with-html-css-and-javascript/">this
                    article</a> by
        ...
        <div id="timer-example" class="enable-example">
            ...
            <p>
                ...
                example accessible.
                                    ...
                                    <div class="showcode">
                <form class="showcode__ui">                                        <div id="timer-example__steps" class="showcode__steps"></div>
                                        <div id="timer-example__notes" class="showcode__notes " role="alert" aria-live="assertive"
                    ></div>
                    <button id="timer-example__notes-view-toggle" class="showcode__notes-view-toggle" aria-describedby="timer-example__toggle-desc"><span
                        class="showcode__notes-view-toggle--more">View More</span><span
                        class="showcode__notes-view-toggle--less">View Less</span>
                    </button>
                    <div id="timer-example__toggle-desc" class="sr-only">This control is not needed for screen reader users.</div>
                ...
                <pre class="showcode__example"><code
                        data-showcode-id="timer-example"
                        data-showcode-props="timer-example-props"
                        tabindex="0"
                        aria-describedby="timer-example__example-desc"
                    >
                    </code>
                </pre>
            </div>
        </div>        <script type="application/json" id="timer-example-props">
        {
            "replaceHtmlRules": {
                "#app": [
    ...
    <script src="js/shared/enable-visible-on-focus.js"></script>    <script src="js/timer.js"></script>
</body>
