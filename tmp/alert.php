        ...
        <div id="visual-alert-example" class="enable-example">
            ...
            <p>
                ...
                <form class="showcode__ui">                                        <div id="visual-alert-example__steps" class="showcode__steps"></div>
                                        <div id="visual-alert-example__notes" class="showcode__notes " role="alert" aria-live="assertive"
                    ></div>
                    <button id="visual-alert-example__notes-view-toggle" class="showcode__notes-view-toggle" aria-describedby="visual-alert-example__toggle-desc"><span
                        class="showcode__notes-view-toggle--more">View More</span><span
                        class="showcode__notes-view-toggle--less">View Less</span>
                    </button>
                    <div id="visual-alert-example__toggle-desc" class="sr-only">This control is not needed for screen reader users.</div>
                ...
                <pre class="showcode__example"><code
                        ...
                        tabindex="0"
                        aria-describedby="visual-alert-example__example-desc"
                    >
                    </code>
                </pre>
            </div>
