        ...
        <div id="html5-def-list-example" class="enable-example">
            ...
            <p>
                ...
                <form class="showcode__ui">                                        <div id="html5-def-list-example__steps" class="showcode__steps"></div>
                                        <div id="html5-def-list-example__notes" class="showcode__notes " role="alert" aria-live="assertive"
                    ></div>
                    <button id="html5-def-list-example__notes-view-toggle" class="showcode__notes-view-toggle" aria-describedby="html5-def-list-example__toggle-desc"><span
                        class="showcode__notes-view-toggle--more">View More</span><span
                        class="showcode__notes-view-toggle--less">View Less</span>
                    </button>
                    <div id="html5-def-list-example__toggle-desc" class="sr-only">This control is not needed for screen reader users.</div>
                ...
                <pre class="showcode__example"><code
                        ...
                        tabindex="0"
                        aria-describedby="html5-def-list-example__example-desc"
                    >
                    </code>
                </pre>
            </div>
        ...
        <div id="aria-def-list-example" class="enable-example">
            ...
            <p>
                ...
                <form class="showcode__ui">                                        <div id="aria-def-list-example__steps" class="showcode__steps"></div>
                                        <div id="aria-def-list-example__notes" class="showcode__notes " role="alert" aria-live="assertive"
                    ></div>
                    <button id="aria-def-list-example__notes-view-toggle" class="showcode__notes-view-toggle" aria-describedby="aria-def-list-example__toggle-desc"><span
                        class="showcode__notes-view-toggle--more">View More</span><span
                        class="showcode__notes-view-toggle--less">View Less</span>
                    </button>
                    <div id="aria-def-list-example__toggle-desc" class="sr-only">This control is not needed for screen reader users.</div>
                ...
                <pre class="showcode__example"><code
                        ...
                        tabindex="0"
                        aria-describedby="aria-def-list-example__example-desc"
                    >
                    </code>
                </pre>
            </div>
