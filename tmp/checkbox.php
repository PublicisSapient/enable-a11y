        ...
        <div id="example-role-checkbox" class="enable-example">
            ...
            <p>
                ...
                <form class="showcode__ui">                                        <div id="example-role-checkbox__steps" class="showcode__steps"></div>
                                        <div id="example-role-checkbox__notes" class="showcode__notes " role="alert" aria-live="assertive"
                    ></div>
                    <button id="example-role-checkbox__notes-view-toggle" class="showcode__notes-view-toggle" aria-describedby="example-role-checkbox__toggle-desc"><span
                        class="showcode__notes-view-toggle--more">View More</span><span
                        class="showcode__notes-view-toggle--less">View Less</span>
                    </button>
                    <div id="example-role-checkbox__toggle-desc" class="sr-only">This control is not needed for screen reader users.</div>
                ...
                <pre class="showcode__example"><code
                        ...
                        tabindex="0"
                        aria-describedby="example-role-checkbox__example-desc"
                    >
                    </code>
                </pre>
            </div>
        ...
        <div id="example-visibleif" class="enable-example">
            ...
            <p>
                ...
                <form class="showcode__ui">                                        <div id="example-visibleif__steps" class="showcode__steps"></div>
                                        <div id="example-visibleif__notes" class="showcode__notes " role="alert" aria-live="assertive"
                    ></div>
                    <button id="example-visibleif__notes-view-toggle" class="showcode__notes-view-toggle" aria-describedby="example-visibleif__toggle-desc"><span
                        class="showcode__notes-view-toggle--more">View More</span><span
                        class="showcode__notes-view-toggle--less">View Less</span>
                    </button>
                    <div id="example-visibleif__toggle-desc" class="sr-only">This control is not needed for screen reader users.</div>

                    <div id="example-visibleif__example-desc" class="showcode__example--desc">
                        ☜ Scroll to see full source ☞
                    </div>
                                    </form>
                <pre class="showcode__example"><code
                        ...
                        tabindex="0"
                        aria-describedby="example-visibleif__example-desc"
                    >
                    </code>
                </pre>
            </div>
