...
<body>
    ...
    <aside class="notes">
        ...
        <ul>
            <li>This example is originally from <a href="http://simplyaccessible.com/article/danger-aria-tabs/">Danger! ARIA tabs</a>, written by <a href="http://simplyaccessible.com/article/author/jeffsmith/">Jeff Smith</a>.</li>
            <li>This doesn't use ARIA roles but a bunch of links with hash-anchors within the page.</li>
            <li>The problem is that a visually-impaired user doesn't realize content is hidden and will miss the hidden content in reading mode.</li>
        </ul>
    </aside>
