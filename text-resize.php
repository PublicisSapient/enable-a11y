...
<body>
    ...
    <main>
        ...
        <h1>Accessible Typography</h1>

        <p>
            A lot of developers don't realize that the way they style typography may not
            be accessible. Below I cover a few things we need to keep in mind:
        </p>

        <ul>
            <li>Use relative units to code font-size to conform to WCAG AA 1.4.4 - Text Resize.</li>
            <li>Check your design doesn't break when users changes the spacing of paragraphs, words, letters and lines
                to conform to WCAG AA 1.4.12 - Text Spacing.</li>
            <li>If you are using viewport units for typography, use it with calc formula involving a relative unit.</li>
            <li>Ensure that type doesn't cut off on text resize or when the user changes letter-spacing or line-spacing
                by using not using <code>max-height</code> with <code>overflow: hidden</code></li>
            <li>Ensure you don't paint text inside the images of your project.</li>
            <li>If you use images inside of SVGs, make sure the text conforms to WCAG AA 1.4.4 - Text Resize and WCAG AA
                1.4.12 - Text Spacing.</li>
        </ul>
    ...
    // http://lesscss.org/features/#features-overview-feature-operations
        ...
        <div class="text-resize__hero">
            <div class="text-resize__hero--text">
                ...
                <p class="text-resize__hero--sub-text">is a Turkish film actor, director, producer and martial artist. He is widely considered one of the most prominent Turkish actors of all
    ...
    font-family: "Times New Roman", serif;
            ...
            <ol>
                <li><strong>Desktop:</strong>
                    <ul>
                        ...
                        <li>Under “Appearance,” next to “Font size,” click the Down arrow <span
                                aria-hidden="true">▾</span>. Then select the font size you want (you have a choice
                            of
        ...
        <li><strong>Internet Explorer:</strong> Go to the menu bar, click “View” and choose the “Text Size” menu
            item.
