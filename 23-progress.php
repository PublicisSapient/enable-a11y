...
<body>
    ...
    <main>
        ...
        <p>This progress bar uses aria-live regions to update the status of the progress bar. It works in for all screen readers.</p>
        ...
        <p>This progress bar uses aria-live regions to update the status of the progress bar.  It is the safest way to ensure your progress bars are accessible.
        ...
        <p>This progress bar uses the screen reader's native functionality to read the progress bar by setting keyboard focus on the bar when incrementing.
            <strong>At the time of this writing, this doesn't work in Voiceover on OSX <= 10.15.7</strong></p>
        ...
        <div id="aria-valuetext-example" class="enable-example">
            <div id="ex3" class="verbose" role="progressbar" aria-valuemin="0" aria-valuemax="7" aria-valuenow="0" data-timeout="4000"
                data-step="1" data-set-valuetext="true" aria-label="Attempting to fulfill order" tabindex="-1">
                <ol>
